...
export const SLIDES: SlideDef[] = [
  ...
  { id: 'recall', title: 'O‘tilgan mavzuni eslaymiz', steps: 4, Component: RecallSlide },
  { id: 'problem', title: 'Muammoli vaziyat', steps: 2, Component: ProblemSlide },
  ...
  { id: 'friction', title: 'Ishqalanish kuchi', steps: 3, Component: FrictionSlide },
