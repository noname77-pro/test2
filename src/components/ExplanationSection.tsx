...
const POINTS = [
  { color: VECTOR_COLORS.weight, title: 'Og‘irlik kuchi', text: 'Og‘irlik kuchi mg vertikal pastga yo‘naladi.' },
  {
    ...
    text: 'Qiya tekislikda u ikki tashkil etuvchiga ajratiladi: mg sin α jismni qiya tekislik bo‘ylab harakatlantiradi.',
  },
  { color: VECTOR_COLORS.perpendicular, title: 'Tayanchga bosim', text: 'mg cos α esa jismni tayanchga bosadi va N bilan muvozanatlashadi.' },
      ...
      <div className="relative grid gap-8 lg:grid-cols-[1fr_1.4fr] lg:gap-14">
        <div>
          ...
          <p className="mt-4 text-lg leading-relaxed text-snow/80">
            ...
            <span className="text-amber">mg sin α</span> jismni qiya tekislik bo‘ylab harakatlantiradi,{' '}
            <span className="text-periwinkle">mg cos α</span> esa tayanchga bosadi. Ishqalanish kuchi harakatga qarshi
            yo‘naladi.
          </p>
        </div>
